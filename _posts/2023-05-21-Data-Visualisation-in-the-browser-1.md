---
layout: post
title: "Data Visualization in the Browser - 1"
comments: true
description: "My Attempts at trying different data visualization methods and frameworks"
keywords: "dummy content"
tags: [web-development, javascript, data, visualization]
---
As a part of my ZS internship, I'm supposed to visualize and render high-dimensional data on the browser, which poses several challenges. If built using the right tools, data visualizations are one of best ways to tell your data science story. But most often, bulky web plugins, large computation requirements, bandwidth limitations turn the best stories into a laggy abstraction.
